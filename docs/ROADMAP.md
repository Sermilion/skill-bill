...
- **Early external signal (observed):** non-maintainers have authored PHP and Golang packs; `bill-feature-task` is the strongest daily workflow and `bill-code-review` the strongest standalone phase.
