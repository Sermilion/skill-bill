...
time, selected and completed routed areas, launched and failed
...
Durable output and telemetry retain only byte/count accounting, lane identifiers
...
and terminal outcomes. Prompts, diffs, source, project
