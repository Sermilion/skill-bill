...
internal fun ReviewCommitUnit.toEnvelope(): Map<String, Any?> =
  linkedMapOf(
...
internal fun ReviewCommitUnit.toAssignedEnvelope(): Map<String, Any?> =
  linkedMapOf(
    "commit_unit_id" to commitUnitId,
    "commit_sha" to commitSha,
    "parent_sha" to parentSha,
...
internal fun ReviewCommitCoverageFact.toEnvelope(): Map<String, Any?> =
  linkedMapOf(
...
internal fun ReviewCommitLaneDecision.toEnvelope(): Map<String, Any?> =
  linkedMapOf(
    "commit_sha" to commitSha,
    "order_index" to orderIndex,
    "lane" to lane,
...
internal fun ReviewCommitLaneRoutingMatrix.toEnvelope(): Map<String, Any?> =
  linkedMapOf(
...
internal fun ReviewLaneBundle.toEnvelope(): Map<String, Any?> =
  linkedMapOf(
...
internal fun ReviewLaneAssembledEntry.toEnvelope(): Map<String, Any?> =
  linkedMapOf(
    "commit_sha" to commitSha,
    "parent_sha" to parentSha,
    "subject" to subject.normalizeLineEndings(),
...
internal fun ReviewLaneBundleSegment.toEnvelope(): Map<String, Any?> =
  linkedMapOf(
