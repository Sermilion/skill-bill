...
internal fun ReviewFindingStats.toPayload(): Map<String, Any?> =
  linkedMapOf(
...
internal fun ReviewHealthStats.toPayload(): Map<String, Any?> =
  linkedMapOf(
...
internal fun ReviewFindingDetail.toPayload(): Map<String, Any?> =
