...
class ExternalPlatformPackResolutionService(
  ...
  fun prepareExternalRegistration(
    ...
    catalogPort.assertRegistrableExternalPack(
  ...
  fun registerSource(
    ...
    configPort.registerExternalPlatformPackSource(
  ...
  fun unregisterSource(
    ...
    configPort.unregisterExternalPlatformPackSource(
  ...
  fun resolveEffectiveCatalog(
    ...
    catalogPort.loadEffectiveCatalog(
      PlatformPackCatalogRequest(
        repoRoot = repoRoot,
        userHome = home,
        environment = environment,
