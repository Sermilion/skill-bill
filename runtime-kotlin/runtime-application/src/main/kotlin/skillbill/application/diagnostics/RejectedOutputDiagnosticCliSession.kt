...
class RejectedOutputDiagnosticCliSession(
  ...
  fun inspect(selector: RejectedOutputDiagnosticSelector, rawOutput: Boolean): RejectedOutputDiagnosticCliResult =
  ...
  fun cleanup(selector: RejectedOutputDiagnosticSelector): Int = database.transaction { unitOfWork ->
