...
import skillbill.infrastructure.fs.GIT_PROCESS_CLEANUP_BUDGET_SECONDS
...
internal data class BoundedExternalProcessRequest(
...
internal data class BoundedExternalProcessResult(
  val exitCode: Int,
  val output: String = "",
...
internal object BoundedExternalProcessRunner {
