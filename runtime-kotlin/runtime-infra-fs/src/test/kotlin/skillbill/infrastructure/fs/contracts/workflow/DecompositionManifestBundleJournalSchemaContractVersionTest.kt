...
import skillbill.infrastructure.fs.DecompositionManifestBundleJournal
...
class DecompositionManifestBundleJournalSchemaContractVersionTest {
  ...
  fun `schema contract_version const matches BUNDLE_JOURNAL_CONTRACT_VERSION`() {
    ...
    assertEquals(BUNDLE_JOURNAL_CONTRACT_VERSION, DecompositionManifestBundleJournal.BUNDLE_CONTRACT_VERSION)
  }
