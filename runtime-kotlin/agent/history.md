...
- SKILL-98 private iOS capmo addon migrated out of tree to external source dir + `addon-manifest.yaml`; skip-worktree/`.git/info/exclude`/local wiring removed; reconcile re-adopts upstream yaml each apply but overlay re-merges on top
Feature flag: N/A
