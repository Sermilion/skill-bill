...
private val blockedReasonPrefixes =
  setOf(
    "limit", "validation", "fix_loop", "git", "store_lock", "needs_human", "schema", "runtime", "unknown",
  )
...
fun normalizedBlockedReason(
  ...
  return if (raw.substringBefore(
      ":",
      missingDelimiterValue = "",
    ) in blockedReasonPrefixes
  ) {
    raw
  } else {
