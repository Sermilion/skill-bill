...
fun buildInstallPlanWireMap(plan: InstallPlan): InstallPlanWireMap = InstallPlanWireMap.from(
  linkedMapOf(
    ...
    InstallPlanPayloadKeys.PLATFORM_PACKS to plan.discoveredPlatformPacks.map { pack ->
      linkedMapOf(
    ...
    InstallPlanPayloadKeys.SKILLS to plan.skills
    ...
    InstallPlanPayloadKeys.STAGING to plan.staging.skillPaths.map { intent ->
      linkedMapOf(
    ...
    InstallPlanPayloadKeys.MCP_REGISTRATION to linkedMapOf(
    ...
    InstallPlanPayloadKeys.RUNTIME_DISTRIBUTION to linkedMapOf(
...
private fun agentTargetWireMap(target: InstallAgentTarget): Map<String, Any?> = linkedMapOf(
...
private fun windowsPreflightWireMap(preflight: WindowsSymlinkPreflight): Map<String, Any?> = linkedMapOf(
