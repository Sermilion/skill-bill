...
internal fun classifyDeliveryOutcome(statusCode: Int): TelemetryDeliveryOutcome {
  ...
  return when {
    statusCode in HTTP_SUCCESS_MIN..HTTP_SUCCESS_MAX -> TelemetryDeliveryOutcome.ACCEPTED
...
class InvalidTelemetryTransportOutcomeError(statusCode: Int) : IllegalStateException(
