...
import skillbill.infrastructure.launcher.process.launch.DEFAULT_FILE_ACTIVITY_GRACE_TIMEOUT
import skillbill.infrastructure.launcher.process.launch.DEFAULT_STATUS_HEARTBEAT_INTERVAL
...
/**
 * Flat builder for launcher tests, which vary one or two fields at a time. Production code constructs
 * [AgentRunProcessRequest] from its field groups directly; this convenience lives in test sources so the
 * production type keeps a single construction path.
 */
