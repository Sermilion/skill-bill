...
import skillbill.contracts.workflow.goal.CLASSPATH_RESOURCE
import skillbill.contracts.workflow.goal.EXPECTED_SCHEMA_ID
import skillbill.contracts.workflow.goal.REPO_RELATIVE_PATH
import skillbill.contracts.workflow.identity.output.CLASSPATH_RESOURCE
import skillbill.contracts.workflow.identity.output.EXPECTED_SCHEMA_ID
import skillbill.contracts.workflow.identity.status.CLASSPATH_RESOURCE
import skillbill.contracts.workflow.identity.status.EXPECTED_SCHEMA_ID
import skillbill.contracts.workflow.identity.status.REPO_RELATIVE_PATH
import skillbill.contracts.workflow.identity.subtask.CLASSPATH_RESOURCE
import skillbill.contracts.workflow.identity.subtask.EXPECTED_SCHEMA_ID
import skillbill.contracts.workflow.identity.subtask.REPO_RELATIVE_PATH
import skillbill.contracts.workflow.identity.task.CLASSPATH_RESOURCE
import skillbill.contracts.workflow.identity.task.EXPECTED_SCHEMA_ID
import skillbill.contracts.workflow.identity.task.REPO_RELATIVE_PATH
import skillbill.contracts.workflow.workflow.CLASSPATH_RESOURCE
import skillbill.contracts.workflow.workflow.EXPECTED_SCHEMA_ID
import skillbill.contracts.workflow.workflow.REPO_RELATIVE_PATH
