...
import skillbill.infrastructure.contracts.workflow.decomposition.wireMap
...
import skillbill.infrastructure.contracts.workflow.featuretask.phase.task.runtime.persistence.wireMap
...
import skillbill.infrastructure.contracts.workflow.goal.status.snapshot
import skillbill.infrastructure.contracts.workflow.goal.status.wireMap
...
internal fun workflowStateSchemaDottedFieldPath(instanceLocation: String): String = when {
