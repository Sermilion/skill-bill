...
internal fun decompositionManifestDottedFieldPath(instanceLocation: String): String = when {
...
internal fun extractDecompositionManifestOffendingValue(instance: JsonNode, instanceLocation: String): String {
