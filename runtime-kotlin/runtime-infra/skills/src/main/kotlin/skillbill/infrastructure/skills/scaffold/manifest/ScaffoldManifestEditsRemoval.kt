...
internal fun removeCodeReviewArea(
  manifestPath: Path,
  area: String,
) {
...
internal fun removePointersBlockKey(
  manifestPath: Path,
  key: String,
) {
  val original = manifestPath.toFile().readText()
...
internal fun removeAddonReferences(
  manifestPath: Path,
  pointerName: String,
) {
  val original = manifestPath.toFile().readText()
...
internal fun removeSkillClassPointer(
  manifestPath: Path,
  pointerSlug: String,
) {
  val original = manifestPath.toFile().readText()
