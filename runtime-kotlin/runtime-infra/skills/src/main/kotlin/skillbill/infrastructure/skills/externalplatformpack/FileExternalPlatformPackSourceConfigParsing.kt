...
internal fun requireExternalPlatformPackEntryMap(configPath: Path, index: Int, entry: Any?): Map<*, *> =
...
internal fun requireExternalPlatformPackEntryPath(configPath: Path, index: Int, map: Map<*, *>): String =
