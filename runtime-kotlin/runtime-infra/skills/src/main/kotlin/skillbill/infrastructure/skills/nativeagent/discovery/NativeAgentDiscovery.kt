package skillbill.infrastructure.skills.nativeagent.discovery
...
fun discoverNativeAgentSources(
  ...
  discoverNativeAgentSourceFiles(
...
internal fun discoverNativeAgentSourceFiles(
  platformPacksRoot: Path,
  skillsRoot: Path? = null,
  selectedPlatforms: List<String>? = null,
): List<Path> =
...
internal fun discoverNativeAgentFilesByDir(
  platformPacksRoot: Path,
  skillsRoot: Path?,
...
internal fun nativeAgentSourceDiscoveryRoots(
  platformPacksRoot: Path,
  skillsRoot: Path?,
  selectedPlatforms: List<String>?,
): List<Path> =
...
private fun isNativeAgentSourceFile(
  file: Path,
  extension: String?,
): Boolean {
