...
internal data class SpecialistMetric(
  val pack: String,
  val area: String,
  val file: String,
...
internal data class SimilarityPair(
  val role: String,
  val firstFile: String,
  val secondFile: String,
  val similarity: Fraction,
)

internal data class PackMetric(
  val pack: String,
...
internal data class SubstanceViolation(
  val id: String,
  val pack: String,
