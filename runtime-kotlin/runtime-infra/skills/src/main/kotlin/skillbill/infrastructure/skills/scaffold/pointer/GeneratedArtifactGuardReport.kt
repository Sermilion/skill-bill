...
internal fun discoverGeneratedArtifactFiles(repoRoot: Path): List<GeneratedArtifactFile> {
...
internal fun validateGeneratedArtifactGuard(repoRoot: Path): GeneratedArtifactGuardReport =
