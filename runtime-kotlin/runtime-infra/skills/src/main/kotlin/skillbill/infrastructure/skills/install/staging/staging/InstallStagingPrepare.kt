...
import skillbill.infrastructure.skills.install.staging.staging.content.internalChildren
...
import skillbill.infrastructure.skills.install.staging.staging.installed.manifests
import skillbill.infrastructure.skills.install.staging.staging.installed.repoRoot
import skillbill.infrastructure.skills.install.staging.staging.installed.selectedPackSkills
import skillbill.infrastructure.skills.install.staging.staging.installed.selectedPlatformSlugs
...
import skillbill.infrastructure.skills.install.staging.staging.installed.suppliedCompactIdentity
...
import skillbill.infrastructure.skills.install.staging.staging.sidecar.parentPointerNames
import skillbill.infrastructure.skills.install.staging.staging.sidecar.parentSkillName
import skillbill.infrastructure.skills.install.staging.staging.sidecar.parentSourceDir
import skillbill.infrastructure.skills.install.staging.staging.sidecar.parentSupportPointers
import skillbill.infrastructure.skills.install.staging.staging.sidecar.platformManifests
...
import skillbill.infrastructure.skills.install.staging.staging.sidecar.selectedPackSkills
import skillbill.infrastructure.skills.install.staging.staging.sidecar.selectedPlatformManifests
import skillbill.infrastructure.skills.install.staging.staging.sidecar.sidecarNames
import skillbill.infrastructure.skills.install.staging.staging.sidecar.skillsRoot
import skillbill.infrastructure.skills.install.staging.staging.sidecar.supportPointers
