...
import skillbill.infrastructure.sqlite.telemetry.lifecycle.telemetry.durations.startedAt
...
import skillbill.infrastructure.sqlite.telemetry.lifecycle.telemetry.truthfulness.ISSUE_KEY
import skillbill.infrastructure.sqlite.telemetry.outbox.apply
import skillbill.infrastructure.sqlite.telemetry.redaction.ISSUE_KEY
import skillbill.infrastructure.sqlite.telemetry.redaction.apply
...
import skillbill.infrastructure.sqlite.telemetry.redaction.salt
...
private fun parseAgentIdArray(rawValue: String, workflowId: String, diagnostics: RuntimeDiagnostics): List<Any?> {
...
private fun durationBetweenSeconds(startedAt: String, finishedAt: String, diagnostics: RuntimeDiagnostics): Long {
...
private fun parseTelemetryTimestamp(value: String, diagnostics: RuntimeDiagnostics, fieldName: String): Instant? =
  runCatching {
    Instant.parse(value)
  }.recoverCatching {
