...
internal class LegacyGoalPlanningPreparationStore(
  ...
  ): Int? = preparationRecord.firstMissingOrIncompleteSubtask(parentGoalWorkflowId, orderedSubtaskIds)

  override fun preparedStatus(
    parentGoalWorkflowId: String,
    subtaskId: Int,
  ): GoalPlanningPreparationStatus? = preparationRecord.preparedStatus(parentGoalWorkflowId, subtaskId)
