...
internal fun encodeReviewAccountingBoundedPayload(summary: ReviewAccountingSummary): Map<String, Any?> =
  linkedMapOf(
...
internal fun ReviewAccountingNode.toPayload(): Map<String, Any?> =
  linkedMapOf(
...
private fun ReviewCommitRoutingAccounting.toPayload(): Map<String, Any?> =
  linkedMapOf(
...
private fun ReviewParentAnalysisConsumption.toPayload(): Map<String, Any?> =
  linkedMapOf(
...
private fun ReviewIntegrationAccounting.toPayload(): Map<String, Any?> =
  linkedMapOf(
    ReviewAccountingPayloadKeys.COMMIT_SEQUENCE_DIGEST to commitSequenceDigest,
    ReviewAccountingPayloadKeys.TERMINAL_OUTCOME to terminalOutcome.wireValue,
...
private fun ReviewLaneSegmentAccounting.toPayload(): Map<String, Any?> =
  linkedMapOf(
...
private fun ReviewAccountingCounters.toPayload(): Map<String, Long> =
  linkedMapOf(
