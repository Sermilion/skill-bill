...
internal fun markLifecycleEmitted(
  connection: Connection,
  tableName: String,
  columnName: String,
  sessionId: String,
...
private fun String.itemsArrayJson(): String =
  JsonCodec.parseObjectOrNull(this)
