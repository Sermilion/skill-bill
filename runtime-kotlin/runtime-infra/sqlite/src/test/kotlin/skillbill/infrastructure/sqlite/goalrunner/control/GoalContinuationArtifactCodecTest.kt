...
class GoalContinuationArtifactCodecTest {
  @Test
  fun `sqlite continuation reader rejects malformed payload instead of treating it as no child`() {
  ...
  @Test
  fun `sqlite continuation reader distinguishes an absent artifact from a malformed artifact`() {
