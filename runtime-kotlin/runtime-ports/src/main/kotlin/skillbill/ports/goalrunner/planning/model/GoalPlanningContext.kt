...
data class GoalPlanningContext(
  ...
  companion object {
    ...
    const val VERIFICATION_MAX_DISCOVERY_FILE_COUNT = 16
    const val VERIFICATION_MAX_HEADINGS_PER_FILE = 50
    const val VERIFICATION_MAX_CATALOG_HEADINGS = 128
    const val VERIFICATION_HISTORY_RECENCY_DAYS = 30

    const val VERIFICATION_MAX_SELECTED_BODIES = 12
    const val VERIFICATION_MAX_BODY_BYTES = 4_096
    const val VERIFICATION_MAX_TOTAL_BODY_BYTES = 32 * 1_024
  }
}
