...
/**
 * Runtime-owned per-skill reconcile APPLY port. Sibling of [InstallReconcilePort]
 * (compute). The adapter recomputes the [skillbill.install.model.ReconciliationPlan] from
 * the SAME inputs and performs the per-skill FILE replacement against the live tree. The
