...
internal object McpStdioServer {
  ...
  internal fun handleLine(
    line: String,
    context: Any,
  ): String? = handleLine(line, componentForLegacyContext(context))
  ...
  private fun callToolResponse(
    ...
    component: McpComponent?,
  ): String = McpProtocolFramer.successResponse(id, callToolResult(params, component))
...
private fun mcpToolErrorResult(
  toolName: String,
  error: Throwable,
): Map<String, Any?> =
  mcpToolResult(
