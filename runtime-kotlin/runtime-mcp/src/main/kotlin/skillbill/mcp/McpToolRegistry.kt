    ...
    mapOf(
      ...
      "feature_task_finished" to objectSchema(
        ...
        properties = mapOf(
          ...
          "parallel_review_requested" to booleanSchema,
          "default_review_agent_id" to stringSchema(),
          "alternative_review_agent_id" to stringSchema(),
          "review_lane_count" to integerSchema,
          "review_lane_statuses" to arraySchema(freeObjectSchema),
          "merged_review_finding_count" to integerSchema,
          "accepted_review_finding_count" to integerSchema,
          "rejected_review_finding_count" to integerSchema,
          "unresolved_review_finding_count" to integerSchema,
        ),
      ),
