...
internal fun TelemetryStatusResult.toCliMap(): Map<String, Any?> =
...
internal fun TelemetrySyncStatusResult.toCliMap(): Map<String, Any?> =
  linkedMapOf<String, Any?>(
    "config_path" to configPath,
    "telemetry_enabled" to telemetryEnabled,
    "telemetry_level" to telemetryLevel,
...
internal fun TelemetryMutationResult.toCliMap(): Map<String, Any?> =
  linkedMapOf(
    "config_path" to configPath,
    "telemetry_enabled" to telemetryEnabled,
    "telemetry_level" to telemetryLevel,
...
internal fun TelemetryProxyCapabilities.toCliMap(): Map<String, Any?> =
  linkedMapOf<String, Any?>(
...
internal fun TelemetryRemoteStatsResult.toCliMap(): Map<String, Any?> =
