...
internal fun assistedPlatformProfiles(): Map<String, AssistedPlatformProfile> =
  buildMap {
...
internal fun platformSlugFromInput(value: String): String =
  value.trim()
    .lowercase()
...
internal fun displayNameFromInput(
  input: String,
  slug: String,
): String =
