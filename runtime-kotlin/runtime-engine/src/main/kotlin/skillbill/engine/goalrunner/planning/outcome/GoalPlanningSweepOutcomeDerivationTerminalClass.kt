...
fun exhaustedDeclineReason(production: GoalPlanningPhaseProduction.RetryableDecline, declines: Int): String =
...
fun malformedReason(phaseId: String, error: Throwable): String =
  "Goal planning '$phaseId' output failed the schema gate and could not be prepared: ${error.message.orEmpty()}"

fun unexpectedPlanningFailureReason(phaseId: String, error: Throwable): String =
...
fun emptyTurnReason(phaseId: String, evidence: GoalPlanningEmptyTurnEvidence): String =
