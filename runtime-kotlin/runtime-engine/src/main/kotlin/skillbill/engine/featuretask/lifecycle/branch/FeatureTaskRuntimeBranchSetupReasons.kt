...
fun branchSetupCreateBlockedReason(
  branch: String,
  baseBranch: String,
  error: String,
): String =
...
fun branchSetupReattachBlockedReason(
  branch: String,
...
fun branchSetupReattachMissingReason(
  branch: String,
  currentBranch: String,
): String =
...
fun branchSetupReattachExistenceUnreadableReason(
  branch: String,
  currentBranch: String,
  error: String,
): String =
