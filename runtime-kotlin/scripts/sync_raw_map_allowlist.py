...
PREFIX_REPLACEMENTS = [
    ...
    ("skillbill.application.workflow.model.GoalObservabilityProgressInput", "skillbill.ports.goalrunner.runner.model.GoalObservabilityProgressInput"),
    ("skillbill.application.workflow.model.GoalObservabilityRuntimeEventInput", "skillbill.ports.goalrunner.runner.model.GoalObservabilityRuntimeEventInput"),
    ("skillbill.application.workflow.model.WorkflowFamily", "skillbill.ports.workflow.persistence.model.WorkflowFamily"),
    ("skillbill.application.workflow.GoalObservabilityArtifacts", "skillbill.ports.goalrunner.runner.GoalObservabilityArtifacts"),
    ("skillbill.application.workflow.reviewPolicyFromLegacyArtifacts", "skillbill.ports.goalrunner.persistence.reviewPolicyFromLegacyArtifacts"),
    ("skillbill.application.workflow.outOfBandAcceptancesFromLegacyArtifacts", "skillbill.ports.goalrunner.persistence.outOfBandAcceptancesFromLegacyArtifacts"),
