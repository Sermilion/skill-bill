...
object FeatureTaskRuntimeHandoffEnvelopeSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-handoff-envelope-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimePhaseLaunchBriefingSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-phase-launch-briefing-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimePhaseHandoffSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-phase-handoff-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimePersistenceSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-persistence-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimeQuarantineSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-quarantine-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimeImplementationAttemptSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-implementation-attempt-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimeCheckpointIdentitySchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-checkpoint-identity-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimeBuildReceiptSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-build-receipt.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimeSharedEvidenceProjectionSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-shared-evidence-projection-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
...
object FeatureTaskRuntimeValidationEvidenceSchemaPaths {
  ...
  const val CLASSPATH_RESOURCE: String =
    "skillbill/infrastructure/contracts/feature-task-runtime-validation-evidence-schema.yaml"
  const val EXPECTED_SCHEMA_ID: String =
