...
- [Skill Bill Teams Roadmap](docs/team-control-plane-roadmap.md): positioning, product principles, and the discovery questions a hosted team control plane would have to answer first
