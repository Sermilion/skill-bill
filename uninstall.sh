...
declare -a RENAMED_SKILL_PAIRS=(
  ...
  'bill-feature-implement:bill-feature'
  'bill-kotlin-feature-implement:bill-feature'
  'bill-feature-implement-agentic:bill-feature'
...
for agent in claude codex junie cursor; do
