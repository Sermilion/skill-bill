...
> This section executes only when a `parallel_review:<agent_id>` modifier is forwarded in the invocation args. If the modifier is absent, skip this section entirely and present the Step 6 output as the final review.

### 7.1 — Validate the modifier
...
The Step 6 specialist fan-out is the default lane. It runs as-is: same selected specialists, same scoped file lists, same briefing. No changes to Steps 1–6.

### 7.3 — Alternative lane
...
### 7.4 — Merge and present findings
